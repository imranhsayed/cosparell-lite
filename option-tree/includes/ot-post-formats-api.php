 ...
 */
if ( ! class_exists( 'cosparell_Post_Formats' ) ) {

  class cosparell_Post_Formats {
    ...
    public function meta_boxes() {
      ...
      $meta_boxes = array(
        cosparell_meta_box_post_format_gallery(),
        cosparell_meta_box_post_format_link(),
        cosparell_meta_box_post_format_quote(),
        cosparell_meta_box_post_format_video(),
        cosparell_meta_box_post_format_audio()
      );
      
      /**
       * Register our meta boxes using the 
       * cosparell_register_meta_box() function.
       */
      foreach( $meta_boxes as $meta_box ) {
      
        cosparell_register_meta_box( $meta_box );
