 ...
 * @since     2.0
 */
if ( ! function_exists( 'cosparell_type_creating_options' ) ) {
  
  function cosparell_type_creating_options() {
    ...
    echo '<div class="format-setting type-textblock wide-desc">';
      ...
      echo '<div class="description">';
        ...
        foreach( cosparell_option_types_array() as $key => $value )
          echo '<li>' . $value . '</li>';
        echo '</ul>';
...
/**
 * cosparell_get_option() option type.
 *
 * This is a callback function to display text about cosparell_get_option().
 *
 * @return    string
 *
 * @access    public
 * @since     2.0
 */
if ( ! function_exists( 'cosparell_type_option_types' ) ) {
  
  function cosparell_type_option_types() {
    ...
    echo '<div class="format-setting type-textblock wide-desc">';
      ...
      echo '<div class="description">';
        ...
        echo '<p>' . sprintf( __( 'The Background option type is for adding background styles to your theme either dynamically via the CSS option type below or manually with %s. The Background option type has filters that allow you to remove fields or change the defaults. For example, you can filter %s to remove unwanted fields from all Background options or an individual one. You can also filter %s. These filters allow you to fine tune the select lists for your specific needs.', 'option-tree' ), '<code>cosparell_get_option()</code>', '<code>cosparell_recognized_background_fields</code>', '<code>cosparell_recognized_background_repeat</code>, <code>cosparell_recognized_background_attachment</code>, <code>cosparell_recognized_background_position</code>, ' . __( 'and', 'option-tree' ) . ' <code>cosparell_type_background_size_choices</code>' ) . '</p>';
        
        echo '<h4>'. __( 'Border', 'option-tree' ) . ':</h4>';      
        echo '<p>' . sprintf( __( 'The Border option type is used to set width, unit, style, and color values. The text input excepts a numerical value and the unit select lets you choose the unit of measurement to add to that value. Currently the default units are %s, %s, %s, and %s. However, you can change them with the %s filter. The style select lets you choose the border style. The default styles are %s, %s, %s, %s, %s, %s, %s, and %s. However, you can change them with the %s filter. The colorpicker saves a hexadecimal color code.', 'option-tree' ), '<code>px</code>', '<code>%</code>', '<code>em</code>', '<code>pt</code>', '<code>cosparell_recognized_border_unit_types</code>', '<code>hidden</code>', '<code>dashed</code>', '<code>solid</code>', '<code>double</code>', '<code>groove</code>', '<code>ridge</code>', '<code>inset</code>', '<code>outset</code>', '<code>cosparell_recognized_border_style_types</code>' ) . '</p>';
...
add_filter( \'cosparell_measurement_unit_types\', \'filter_measurement_unit_types\', 10, 2 );</code></pre>';
...
add_filter( \'cosparell_measurement_unit_types\', \'filter_measurement_unit_types\', 10, 2 );</code></pre>';
        ...
        echo '<p>' . sprintf( __( 'the Radio Images option type is primarily used for layouts. However, you can filter the image list using %s. As well, you can add your own custom images using the choices array.', 'option-tree' ), '<code>cosparell_radio_images</code>' ) . '</p>';
        
        echo '<p>' . __( 'This example executes the <code>cosparell_radio_images</code> filter on layout images attached to the <code>my_radio_images</code> field. Added to <code>functions.php</code>.', 'option-tree' ) . '</p>';
...
add_filter( \'cosparell_radio_images\', \'filter_radio_images\', 10, 2 );</code></pre>';
        ...
        echo '<p>' . sprintf(  __( 'This option type makes it possible for users to select a WordPress registered sidebar to use on a specific area. By using the two provided filters, %s, and %s we can be selective about which sidebars are available on a specific content area.', 'option-tree' ), '<code>cosparell_recognized_sidebars</code>', '<code>cosparell_recognized_sidebars_{$field_id}</code>' ) . '</p>';
...
add_filter( \'cosparell_wpautop\', \'filter_textarea_wpautop\', 10, 2 );</code></pre>';
...
add_filter( \'cosparell_media_buttons\', \'filter_textarea_media_buttons\', 10, 2 );</code></pre>';
...
add_filter( \'cosparell_tinymce\', \'filter_textarea_tinymce\', 10, 2 );</code></pre>';
...
add_filter( \'cosparell_quicktags\', \'filter_textarea_quicktags\', 10, 1 );</code></pre>';
...
add_filter( \'cosparell_wpautop\', \'filter_textarea_simple_wpautop\', 10, 2 );</code></pre>';
        ...
        echo '<p>' . sprintf( __( 'The Typography option type is for adding typography styles to your theme either dynamically via the CSS option type above or manually with %s. The Typography option type has filters that allow you to remove fields or change the defaults. For example, you can filter %s to remove unwanted fields from all Background options or an individual one. You can also filter %s. These filters allow you to fine tune the select lists for your specific needs.', 'option-tree' ), '<code>cosparell_get_option()</code>', '<code>cosparell_recognized_typography_fields</code>', '<code>cosparell_recognized_font_families</code>, <code>cosparell_recognized_font_sizes</code>, <code>cosparell_recognized_font_styles</code>, <code>cosparell_recognized_font_variants</code>, <code>cosparell_recognized_font_weights</code>, <code>cosparell_recognized_letter_spacing</code>, <code>cosparell_recognized_line_heights</code>, <code>cosparell_recognized_text_decorations</code> ' . __( 'and', 'option-tree' ) . ' <code>cosparell_recognized_text_transformations</code>' ) . '</p>';
        
        echo '<p class="aside">' . __( 'This example would filter <code>cosparell_recognized_font_families</code> to build your own font stack. Added to <code>functions.php</code>.', 'option-tree' ) . '</p>';
        echo '<pre><code>function filter_cosparell_recognized_font_families( $array, $field_id ) {
...
add_filter( \'cosparell_recognized_font_families\', \'filter_cosparell_recognized_font_families\', 10, 2 );</code></pre>';

        echo '<h4>'. __( 'Upload', 'option-tree' ) . ':</h4>'; 
        echo '<p>' . sprintf( __( 'The Upload option type is used to upload any WordPress supported media. After uploading, users are required to press the "%s" button in order to populate the input with the URI of that media. There is one caveat of this feature. If you import the theme options and have uploaded media on one site the old URI will not reflect the URI of your new site. You will have to re-upload or %s any media to your new server and change the URIs if necessary.', 'option-tree' ), apply_filters( 'cosparell_upload_text', __( 'Send to OptionTree', 'option-tree' ) ), 'FTP' ) . '</p>';
 ...
 * @since     2.0
 */
if ( ! function_exists( 'cosparell_type_cosparell_get_option' ) ) {
  
  function cosparell_type_cosparell_get_option() {
    ...
    echo '<div class="format-setting type-textblock wide-desc">';
      ...
      echo '<div class="description">';
        ...
        echo '<p><code>&lt;?php cosparell_get_option( $option_id, $default ); ?&gt;</code></p>';
 ...
 * @since     2.0
 */
if ( ! function_exists( 'cosparell_type_get_option_tree' ) ) {
  
  function cosparell_type_get_option_tree() {
    ...
    echo '<div class="format-setting type-textblock wide-desc">';
      ...
      echo '<div class="description">';
        ...
        echo '<p>' . __( 'Use', 'option-tree' ) . '<code>cosparell_get_option()</code>' . __( 'instead', 'option-tree' ) . '.</p>';
 ...
 * @since     2.0
 */
if ( ! function_exists( 'cosparell_type_examples' ) ) {
  
  function cosparell_type_examples() {
  ...
  $ids = cosparell_get_option( \'navigation_ids\', array() );
  ...
  if ( ! empty( $ids ) )
    ...
    echo \'&lt;/ul&gt;\';
        ...
        echo '<pre><code>if ( function_exists( \'cosparell_get_option\' ) ) {
  /* get the array */
  $measurement = cosparell_get_option( \'measurement_option_type_id\' );
  ...
  $measurement = cosparell_get_option( \'measurement_option_type_id\', array( \'10\', \'px\' ) );
  ...
  $slides = cosparell_get_option( \'my_slider\', array() );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'cosparell_type_layouts_overview' ) ) {
  
  function cosparell_type_layouts_overview() {
 ...
 * @since     2.0
 */
if ( ! function_exists( 'cosparell_type_meta_boxes' ) ) {
  
  function cosparell_type_meta_boxes() {
...
require( trailingslashit( get_template_directory() ) . \'includes/meta-boxes.php\' );
        ...
        echo '<ul class="docs-ul">';
          echo '<li>' . __( 'Add a variation of the following code to your <code>meta-boxes.php</code>. You\'ll obviously need to fill it in with all your custom array values. It\'s important to note here that we use the <code>admin_init</code> filter because if you were to call the <code>cosparell_register_meta_box</code> function before OptionTree was loaded the sky would fall on your head.', 'option-tree' ) . '</li>';
        echo '</ul>';
...
function custom_meta_boxes() {
  ...
  cosparell_register_meta_box( &#36;my_meta_box );
 ...
 * @since     2.0
 */
if ( ! function_exists( 'cosparell_type_theme_mode' ) ) {
  
  function cosparell_type_theme_mode() {
    ...
    echo '<div class="format-setting type-textblock wide-desc">';
      ...
      echo '<div class="description">';
        ...
        echo '<p>' . __( 'There are a few simple steps you need to take in order to use OptionTree as a theme included module. In the code below I\'ll show you a basic demo of how to include the entire plugin as a module, which will allow you to have the most up-to-date version of OptionTree without ever needing to hack the core of the plugin. If you would like to see some demo code, there is a directory named <code>cosparell</code> inside the <code>assets</code> directory that contains a file named <code>demo-theme-options.php</code> you can reference.', 'option-tree' ) . '</p>';
...
require( trailingslashit( get_template_directory() ) . \'option-tree/ot-loader.php\' );
        ...
        echo '<p>' . sprintf( __( 'For a list of all the OptionTree UI display filters refer to the %s file found in the %s directory of this plugin. This file is the starting point for developing themes with Theme Mode.', 'option-tree' ), '<code>demo-functions.php</code>', '<code>/assets/cosparell/</code>' ) . '</p>';
...
function custom_theme_options() {
   ...
   */
  &#36;saved_settings = get_option( 'cosparell_settings', array() );
  ...
  if ( &#36;saved_settings !== &#36;custom_settings ) {
    update_option( 'cosparell_settings', &#36;custom_settings ); 
  }
